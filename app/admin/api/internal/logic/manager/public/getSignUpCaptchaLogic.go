...
func (l *GetSignUpCaptchaLogic) GetSignUpCaptcha(req *types.Manager_Public_GetSignUpCaptcha_Request) (resp *types.Manager_Public_GetSignUpCaptcha_Response, err error) {
